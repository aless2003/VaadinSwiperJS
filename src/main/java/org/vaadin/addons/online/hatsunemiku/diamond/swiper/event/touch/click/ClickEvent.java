...
/**
 * An event that will be fired when the user clicks/taps on the Swiper.
 * Read the <a href="https://swiperjs.com/api/#events">Swiper.js documentation</a> for more information.
 */
@DomEvent("flow-swiper-click")
public class ClickEvent extends ComponentEvent<Swiper> {
   ...
   */
  public ClickEvent(Swiper source, boolean fromClient) {
