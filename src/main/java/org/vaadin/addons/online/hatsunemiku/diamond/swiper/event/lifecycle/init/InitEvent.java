...
/**
 * An event that will be fired when the {@link Swiper} is being initialized.
 * Read the <a href="https://swiperjs.com/api/#events">Swiper.js documentation</a> for more information.
 */
@DomEvent("flow-swiper-init")
public class InitEvent extends ComponentEvent<Swiper> {
   ...
   */
  public InitEvent(Swiper source, boolean fromClient) {
