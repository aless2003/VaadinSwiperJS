...
/**
 * An event that will be fired when the {@link Swiper} goes from beginning or end position.
 * Read the <a href="https://swiperjs.com/api/#events">Swiper.js documentation</a> for more information.
 */
@DomEvent("flow-swiper-fromedge")
public class FromEdgeEvent extends ComponentEvent<Swiper> {
   ...
   */
  public FromEdgeEvent(Swiper source, boolean fromClient) {
