...
/**
 * An event that will be fired after a "loop fix".
 * Read the <a href="https://swiperjs.com/api/#events">Swiper.js documentation</a> for more information.
 */
@DomEvent("flow-swiper-loopfix")
public class LoopFixEvent extends ComponentEvent<Swiper> {
   ...
   */
  public LoopFixEvent(Swiper source, boolean fromClient) {
