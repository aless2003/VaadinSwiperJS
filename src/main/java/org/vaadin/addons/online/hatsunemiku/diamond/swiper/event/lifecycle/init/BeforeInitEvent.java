...
/**
 * An event that will be fired right before the {@link Swiper} is being initialized.
 * Read the <a href="https://swiperjs.com/api/#events">Swiper.js documentation</a> for more information.
 */
@DomEvent("flow-swiper-beforeinit")
public class BeforeInitEvent extends ComponentEvent<Swiper> {
   ...
   */
  public BeforeInitEvent(Swiper source, boolean fromClient) {
