...
/**
 * An event that will be fired when the user double taps on the {@link Swiper}
 * Read the <a href="https://swiperjs.com/api/#events">Swiper.js documentation</a> for more information.
 */
@DomEvent("flow-swiper-doubletap")
public class DoubleTapEvent extends ComponentEvent<Swiper> {
   ...
   */
  public DoubleTapEvent(Swiper source, boolean fromClient) {
